...
export function generateDisclaimerPrefix(config: DisclaimerConfig): string {
  ...
  const disclaimers: Record<string, string> = {
    ...
    whatsapp: `[This is an automated message from ${companyName}. For official information, please visit our website or contact our team directly.]`,
