CREATE TABLE "ai_sticker_metrics" (
...
CREATE INDEX "ai_sticker_metrics_user_sticker_idx" ON "ai_sticker_metrics" USING btree ("user_id","sticker_id");--> statement-breakpoint
CREATE INDEX "pending_payments_lead_idx" ON "pending_payments" USING btree ("lead_id");--> statement-breakpoint
CREATE INDEX "pending_payments_user_status_idx" ON "pending_payments" USING btree ("user_id","status");