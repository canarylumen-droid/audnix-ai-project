...
export const PRICING_TIERS: PricingTier[] = [
  {
    ...
    features: [
      '100 leads to test',
      'Email automation',
      'AI Sales Assistant (replies to leads automatically)',
  ...
  },
  {
    ...
    price: 0,
    period: 'forever',
    description: 'Keep using it free. No limits, no hidden charges.',
    leadsLimit: 100,
    voiceMinutes: 0,
    order: 0,
    features: [
  ...
  },
  {
    ...
    features: [
      ...
      'AI Sales Assistant (email + voice notes)',
  ...
  },
  {
    ...
    features: [
      ...
      'Custom playbooks for your objections',
  ...
  },
  {
    ...
    price: 199.99,
    period: 'month',
    description: 'Unlimited scale. Unlimited leads. Full control.',
    leadsLimit: 20000,
    voiceMinutes: 1000,
    order: 3,
    features: [
