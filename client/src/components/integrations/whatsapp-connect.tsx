...
export function WhatsAppConnect() {
  ...
  const [authMethod, setAuthMethod] = useState<'otp' | 'qr'>('qr');
  ...
  const handleSendOTP = async () => {
    ...
    try {
      ...
      if (response.ok) {
        setOtpSent(true);
        toast({
          title: 'OTP Sent by WhatsApp',
          description: 'Check your WhatsApp app for the 6-digit code',
        });
      } else {
            ...
            {authMethod === 'otp' && (
              <div className="space-y-3">
                <div className="text-sm text-muted-foreground">
                  <p className="font-medium mb-2">📱 WhatsApp will send you a code</p>
                  <p>Enter your phone number and WhatsApp will send a 6-digit verification code directly to your WhatsApp app.</p>
                </div>
                  ...
                  <div className="space-y-3">
                    <div className="p-3 bg-blue-50 dark:bg-blue-950/20 rounded-lg">
                      ...
                      <p className="text-xs text-blue-600 dark:text-blue-400 mt-1">
                        Check your WhatsApp app for the code
                      </p>
                    </div>
                    <div>
