      ...
      <div className="max-w-7xl mx-auto px-6 relative">
        ...
        <div className="text-center pt-32 mb-32 relative">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-muted border border-border text-primary text-[10px] font-black uppercase tracking-[0.3em] mb-12 shadow-[0_0_20px_rgba(var(--primary),0.1)]"
          >
              ...
              >
                ...
                <div className="mb-10">
                  <div className="flex items-center justify-between mb-8">
                    <h3 className="text-muted-foreground text-[10px] font-black uppercase tracking-[0.4em]">{tier.name}</h3>
                ...
                <div className="space-y-5 mb-10 flex-1">
                  {tier.features.map((feature, i) => (
                    <div key={i} className="flex items-start gap-4">
                      ...
                      <span className="text-muted-foreground font-bold text-[13px] leading-snug uppercase tracking-tight">
                        {feature}
                      </span>
                    </div>
                  ))}
        ...
        >
          <p className="text-[10px] font-black uppercase tracking-[0.5em] text-muted-foreground/40 mb-12">
